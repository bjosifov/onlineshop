...
public class StoreNavigationActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StoreNavigationActivity.this, CartActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            android.support.v4.app.FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment, phoneFragment).commit();
        } else if (id == R.id.nav_laptops) {
            //setTitle("Latops");
            LaptopFragment laptopFragment = new LaptopFragment();
            android.support.v4.app.FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.fragment, laptopFragment).commit();
    ...
    public void navigateToLoginAct(){
        Intent intent = new Intent(StoreNavigationActivity.this, MainActivity.class);
